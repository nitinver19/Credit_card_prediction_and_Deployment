...
BILL_AMT4 = st.text_input('Last 4th month bill amount','90000')
BILL_AMT5 = st.text_input('Last 5th month bill amount','0')
BILL_AMT6 = st.text_input('Last 6th month bill amount','30000')
...
PAY_AMT3 = st.text_input('Amount paid in last 3rd month','0')
PAY_AMT4 = st.text_input('Amount paid in last 4th month','0')
PAY_AMT5 = st.text_input('Amount paid in last 5th month','0')
